...
public class IterateOverLinkedHashMap {
	...
	public static void main(String[] args) {
		...
		userCityMapping.put("Angelina", "Pune");
		userCityMapping.put("David", "Mumbai");
		userCityMapping.put("Jerry", "Delhi");
		userCityMapping.put("Chris", "Gujarat");

		System.out.println("userCityMapping=> " + userCityMapping);
